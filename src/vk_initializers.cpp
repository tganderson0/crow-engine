...
VkPipelineRasterizationStateCreateInfo vkinit::rasterization_state_create_info(VkPolygonMode polygonMode)
{
	...
	// Discards all primitives before the reasterization stage if enabled which we don't want
...
VkPipelineLayoutCreateInfo vkinit::pipeline_layout_create_info()
{
	...
	// Won't be null if shader has an input
...
{
	// Builds an image-view for the depth image to use for rendering
...
VkPipelineDepthStencilStateCreateInfo vkinit::depth_stencil_create_info(bool bDepthTest, bool bDepthWrite, VkCompareOp compareOp)
{
	...
	info.depthWriteEnable = bDepthTest ? VK_TRUE : VK_FALSE;
